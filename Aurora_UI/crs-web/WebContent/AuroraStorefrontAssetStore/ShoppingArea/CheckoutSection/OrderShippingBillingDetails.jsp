		...
		<c:choose>     
			...
			<c:otherwise>
				...
				<script type="text/javascript">
					...
					<c:if test="${not empty WCParam.razorPayErrorMessage}">
						var razorPayErrorMessage = 'There is some issue in razorpay payment. Please select any other payment option. ';
						MessageHelper.displayErrorMessage(razorPayErrorMessage);
					</c:if>
				</script>
