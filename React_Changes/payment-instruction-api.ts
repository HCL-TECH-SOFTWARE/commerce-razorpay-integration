...
export const PaymentInstructionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createRazorPayOrder: async (storeId: string, responseFormat?: string, body?: CreateRazorPayOrder, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'storeId' is not null or undefined
            assertParamExists('createRazorPayOrder', 'storeId', storeId)
            const localVarPath = `/store/{storeId}/razorpay/createorder`
                .replace(`{${"storeId"}}`, String(storeId));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const PaymentInstructionApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createRazorPayOrder(storeId: string, responseFormat?: string, body?: CreateRazorPayOrder, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ComIbmCommerceRestOrderHandlerPaymentInstructionHandlerPaymentInstructionList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createRazorPayOrder(storeId, responseFormat, body, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Deletes all payment instructions from the shopping cart.
...
export const PaymentInstructionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        createRazorPayOrder(storeId: string, responseFormat?: string, body?: CreateRazorPayOrder, options?: any): AxiosPromise<ComIbmCommerceRestOrderHandlerPaymentInstructionHandlerPaymentInstructionList> {
            return localVarFp.createRazorPayOrder(storeId, responseFormat, body, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes all payment instructions from the shopping cart.
         * @summary Delete payment instructions
...
export class PaymentInstructionApi extends BaseAPI {
    ...
    public createRazorPayOrder(storeId: string, responseFormat?: string, body?: CreateRazorPayOrder, options?: any) {
        return PaymentInstructionApiFp(this.configuration).createRazorPayOrder(storeId, responseFormat, body, options).then((request) => request(this.axios, this.basePath));
    }
